...
| `tower-api.jinwang.dev` | `https://192.168.88.100:6443` | Tower K8s API (외부 kubectl 접근 시 필수) |
| `sandbox-api.jinwang.dev` | `https://192.168.88.110:6443` | Sandbox K8s API (외부 kubectl 접근 시 필수) |
